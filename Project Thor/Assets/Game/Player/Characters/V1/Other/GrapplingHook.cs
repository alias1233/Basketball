...
{
    public V1Movement OwningPlayerMovement;
    ...
    {
        V1Movement[] playermovements = FindObjectsByType<V1Movement>(FindObjectsSortMode.None);

        foreach (V1Movement i in playermovements)
        {
